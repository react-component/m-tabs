                ...
                __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                        ...
                        { tabs: tabData, onChange: function onChange(tab, index) {
                                ...
                                return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__src__["b" /* DefaultTabBar */], props);
                            } },
                        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                            'div',
                    ...
                    __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                        ...
                        { tabs: tabData, onChange: function onChange(tab, index) {
                                ...
                                return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__src__["b" /* DefaultTabBar */], _extends({}, props, { page: 4 }));
                            } },
                        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                            'div',
                            { style: { padding: 10, background: '#ADFFD7' } },
                    ...
                    __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                        ...
                        { style: { background: '#eee', boxShadow: '0 0 0 5px #eee', margin: 10, padding: 10 }, onClick: function onClick() {
                                _this2.setState({
                                    dynamicTabs: [].concat(_toConsumableArray(_this2.state.dynamicTabs), [{ title: 'title-' + _this2.state.dynamicTabs.length + 1 }])
                                });
                            } },
                        'add page'
                    ),
                    __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                        ...
                        { tabs: this.state.dynamicTabs, onChange: function onChange(tab, index) {
                                ...
                                return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__src__["b" /* DefaultTabBar */], _extends({}, props, { page: 3 }));
                            } },
                        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                            'div',
                            { style: { padding: 10, background: '#ADFFD7' } },
