                ...
                __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                        ...
                        { tabs: [{ key: 't1', title: 't1' }, { key: 't2', title: 't2' }, { key: 't3', title: 't3' }, { key: 't4', title: 't4' }], initialPage: 't2', renderTabBar: function renderTabBar(props) {
                                return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__src__["b" /* DefaultTabBar */], _extends({}, props, { renderUnderline: function renderUnderline(ulProps) {
                                        var style = ulProps.style,
                                            otherProps = __rest(ulProps, ["style"]);
                                        var ulStyle = _extends({}, style, { border: 'none' });
                                        return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
                                            'div',
                                            _extends({ style: ulStyle }, otherProps),
                                            __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement('div', { style: {
                                                    width: 50,
                                                    height: 2,
                                                    backgroundColor: 'red',
